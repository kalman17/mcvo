#!/bin/bash
#SBATCH --job-name=Cb4_h100
#SBATCH --output=/storage/user/maka/logs/train_Cb_v4_h100_%j.out
#SBATCH --error=/storage/user/maka/logs/train_Cb_v4_h100_%j.err
...
TRAIN_DIR="/storage/user/maka/train/phase_Cb_v4_h100"
...
echo "============================================"
echo "  Phase Cb v4 H100 — Joint training with composed flow loss"
echo "  Phase A v4 (ep5) + B1 v2 (best)"
echo "  Host: $(hostname)"
...
echo ""
echo "=== Phase Cb v4 H100 Training (20 epochs, batch_size=10, lr=2e-5 cosine) ==="
...
echo ""
echo "=== Phase Cb v4 H100 COMPLETE ==="
echo "Date: $(date)"
