#!/bin/bash
#SBATCH --job-name=bench_2fps
#SBATCH --output=/storage/user/maka/logs/bench_training_fps_%j.out
#SBATCH --error=/storage/user/maka/logs/bench_training_fps_%j.err
#SBATCH --partition=NORMAL
#SBATCH --comment="Masters thesis deadline 2026-03-31, benchmark at training FPS"
...
echo "============================================"
echo "  Benchmark at Training FPS (2fps)"
echo "  dilation_mode=training"
echo "  sintel=12, tumrgbd=15, kitti=5"
echo "  Host: $(hostname)"
...
# --- 1. Phase C epoch 5 (+ baselines) ---
echo ""
echo "=== Phase C epoch 5 (with baselines) ==="
...
echo ""
echo "=== Phase C epoch 5 DONE ==="
echo "Date: $(date)"

# --- 2. Phase Db epoch 2 (skip baselines, reuse cache) ---
echo ""
echo "=== Phase Db epoch 2 (skip baselines) ==="
