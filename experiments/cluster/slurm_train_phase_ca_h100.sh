#!/bin/bash
#SBATCH --job-name=train_Ca_h
#SBATCH --output=/storage/user/maka/logs/train_Ca_h100_%j.out
#SBATCH --error=/storage/user/maka/logs/train_Ca_h100_%j.err
...
TRAIN_DIR="/storage/user/maka/train/phase_Ca_v3_h100"
...
echo "============================================"
echo "  Phase Ca H100 — Joint pose_head + FAT (backbones frozen)"
echo "  Host: $(hostname)"
...
echo ""
echo "=== Phase Ca Training H100 (20 epochs, batch_size=10, lr=3e-5 cosine) ==="
