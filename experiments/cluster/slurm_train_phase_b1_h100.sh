#!/bin/bash
#SBATCH --job-name=train_B_h
#SBATCH --output=/storage/user/maka/logs/train_B_h100_%j.out
#SBATCH --error=/storage/user/maka/logs/train_B_h100_%j.err
...
TRAIN_DIR="/storage/user/maka/train/phase_B1_v2_h100"
...
echo "============================================"
echo "  Phase B1 v2 — FAT Pre-Training (H100)"
echo "  Host: $(hostname)"
...
echo ""
echo "=== Phase B1 Training (10 epochs, batch_size=16, H100) ==="
...
echo ""
echo "=== Phase B1 v2 (H100) COMPLETE ==="
echo "Date: $(date)"
