#!/bin/bash
#SBATCH --job-name=train_Db
#SBATCH --output=/storage/user/maka/logs/train_Db_%j.out
#SBATCH --error=/storage/user/maka/logs/train_Db_%j.err
#SBATCH --partition=NORMAL
#SBATCH --comment="Masters thesis deadline 2026-03-31, Phase Db pose-path layers"
...
TRAIN_DIR="/storage/user/maka/train/phase_Db"
...
echo "============================================"
echo "  Phase Db — Pose-Path Fine-Tuning (ADA/AMPERE)"
...
echo ""
echo "=== Phase Db Training (10 epochs, batch_size=12, pose-path layers) ==="
