...
#SBATCH --output=/storage/user/maka/logs/train_A3_%j.out
#SBATCH --error=/storage/user/maka/logs/train_A3_%j.err
...
TRAIN_DIR="/storage/user/maka/train/phase_A_v3"
...
echo "============================================"
echo "  Phase A v3 — Pose Head Training (flow fix + focal conditioning)"
echo "  Host: $(hostname)"
