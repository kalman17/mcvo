#!/bin/bash
#SBATCH --job-name=train_C_v3h
#SBATCH --output=/storage/user/maka/logs/train_C_v3_h100_%j.out
#SBATCH --error=/storage/user/maka/logs/train_C_v3_h100_%j.err
#SBATCH --partition=NORMAL
#SBATCH --comment="Masters thesis deadline 2026-03-31, Phase C v3 frozen backbones (H100)"
...
TRAIN_DIR="/storage/user/maka/train/phase_C_v3_h100"
...
echo "============================================"
echo "  Phase C v3 — Frozen Backbones (H100)"
...
echo ""
echo "=== Phase C v3 Training (10 epochs, batch_size=20, frozen backbones, H100) ==="
