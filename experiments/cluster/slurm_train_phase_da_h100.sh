#!/bin/bash
#SBATCH --job-name=train_Da_h
#SBATCH --output=/storage/user/maka/logs/train_Da_h100_%j.out
#SBATCH --error=/storage/user/maka/logs/train_Da_h100_%j.err
#SBATCH --partition=NORMAL
#SBATCH --comment="Masters thesis deadline 2026-03-31, Phase Da pose_head only (H100)"
...
TRAIN_DIR="/storage/user/maka/train/phase_Da_h100"
...
echo "============================================"
echo "  Phase Da — Pose-Only Fine-Tuning (H100)"
echo "  Only pose_head trainable (~21K params)"
...
echo ""
echo "=== Phase Da Training (10 epochs, batch_size=20, pose_head only, H100) ==="
