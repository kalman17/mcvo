#!/bin/bash
#SBATCH --job-name=train_Ca
#SBATCH --output=/storage/user/maka/logs/train_Ca_%j.out
#SBATCH --error=/storage/user/maka/logs/train_Ca_%j.err
...
TRAIN_DIR="/storage/user/maka/train/phase_Ca_v3"
...
echo "============================================"
echo "  Phase Ca — Joint pose_head + FAT (backbones frozen)"
echo "  Host: $(hostname)"
