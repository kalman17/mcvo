#!/bin/bash
#SBATCH --job-name=Cb5_h100
#SBATCH --output=/storage/user/maka/logs/train_Cb_v5_h100_%j.out
#SBATCH --error=/storage/user/maka/logs/train_Cb_v5_h100_%j.err
...
TRAIN_DIR="/storage/user/maka/train/phase_Cb_v5_h100"

# Resume from Cb v4 H100 epoch 5 (last clean before NaN at epoch 7)
RESUME_CKPT="/storage/user/maka/train/phase_Cb_v4_h100/checkpoints/epoch_0005.pt"
...
echo "============================================"
echo "  Phase Cb v5 H100 — Stability fixes"
...
echo "    - Resume from Cb v4 H100 epoch 5 (weights only)"
echo "  Host: $(hostname)"
...
echo ""
echo "=== Phase Cb v5 H100 Training (20 epochs, batch_size=10, lr=2e-5 cosine, wd=1e-5, clip=0.3) ==="
...
echo ""
echo "=== Phase Cb v5 H100 COMPLETE ==="
echo "Date: $(date)"
