#!/bin/bash
#SBATCH --job-name=train_Da
#SBATCH --output=/storage/user/maka/logs/train_Da_%j.out
#SBATCH --error=/storage/user/maka/logs/train_Da_%j.err
#SBATCH --partition=NORMAL
#SBATCH --comment="Masters thesis deadline 2026-03-31, Phase Da pose_head only"
...
TRAIN_DIR="/storage/user/maka/train/phase_Da"
...
echo "============================================"
echo "  Phase Da — Pose-Only Fine-Tuning (ADA/AMPERE)"
...
echo ""
echo "=== Phase Da Training (10 epochs, batch_size=12, pose_head only) ==="
