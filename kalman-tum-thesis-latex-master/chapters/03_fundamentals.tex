...
To address this, modern systems employ visibility masks, forward--backward consistency checks, or robust loss functions that reduce the influence of unreliable regions. These mechanisms ensure that learning is driven primarily by valid geometric correspondences.

To address this, modern systems employ visibility masks, forward--backward consistency checks, or uncertainty-aware weighting, which down-weights unreliable regions based on learned confidence estimates.
