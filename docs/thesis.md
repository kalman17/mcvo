# The calibration branch: MCT (master's thesis, TU Munich 2026)

*This is the thesis material that used to be the README of this repository. The current README leads with MCVO; MCT is kept here in full for reproducibility. Numbers here are the corrected ones (see [../CHANGELOG.md](../CHANGELOG.md)).*
